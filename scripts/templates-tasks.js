    ...
    return `
        <div class="field-group flex-col flex-grow">
            ...
            <div class="field-wrapper has-alert">
                ...
                <input type="text" id="inputTitle" name="title" placeholder="Enter a title" required maxlength="128" oninput="onInputHandler(event)" onfocus="focusInHandler(event)" onfocusout="focusOutHandler(event)">
            ...
            <div class="field-wrapper has-alert">
                ...
                <input type="date" id="inputDueDate" name="dueDate" required min="2000-01-01" max="2099-12-31" step="1" oninput="onInputHandler(event)" onfocus="focusInHandler(event)" onfocusout="focusOutHandler(event)" onkeyup="removePlaceholderStyle(event)" data-placeholder-style="true">
